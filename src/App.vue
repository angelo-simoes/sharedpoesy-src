...
<template>
  <header>
    <router-link to="/">Goooo to Home</router-link>
    <img
      alt="Logo"
      class="logo"
      src="./assets/logo.svg"
...
if (import.meta.env.MODE === "production")
  pocketbase_ip = "https://www.sharedpoesy.angelo-simoes.fr:443";
...
@media (min-width: 1024px) {
  ...
  .logo {
    ...
    <div class="wrapper" id="signOut">
      <div><SignIn msg="INSCRIS-TOI !" /></div>
      <label>email: </label><br />
...
var pocketbase_ip = "";
if (import.meta.env.MODE === "production")
  pocketbase_ip = "http://193.168.146.42:80";
else pocketbase_ip = "http://127.0.0.1:8090";
const pb = new PocketBase(pocketbase_ip);
